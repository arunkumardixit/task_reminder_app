...
class Task extends _Task with RealmEntity, RealmObjectBase, RealmObject {
  ...
  DateTime get reminderTime =>
      RealmObjectBase.get<DateTime>(this, 'reminderTime') as DateTime;
  @override
    ...
    return switch (ejson) {
      {
        ...
        'reminderTime': EJsonValue reminderTime,
      } =>
        Task(
          fromEJson(id),
          fromEJson(title),
  ...
  static final schema = () {
    ...
    return const SchemaObject(ObjectType.realmObject, Task, 'Task', [
      ...
      SchemaProperty('reminderTime', RealmPropertyType.timestamp),
    ]);
  }();
